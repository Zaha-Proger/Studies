...
function getHtmlForButton(nameStr, str, bClass,onClickFn){
    ...
    document.writeln('\
    <input type="button" name="',nameStr,'" id="',nameStr,'" value="',str,'" class="',bClass,'"  onClick="',onClickFn,'">\
    ')
}
...
if(str == null || str =="") {
	document.writeln('\
	<input type="button" name="apply" id="apply" value="',top.APPLY,'" class="button" onClick="javascript:submitAction()">\
	')
}
else{
	document.writeln('\
	<input type="button" name="apply" id="apply" value="',str,'" class="button" onClick="javascript:submitAction()">\
	')
}
}
...
debugMsg("getHtmlForApplyButton access granted");
document.writeln('\
	<input type="button" name="apply" id="apply" value="Submit" onClick="javascript:submitAction()">\
	')
}
...
debugMsg("getHtmlForEditButton");
	document.writeln('\
	<input type="button" name="remove" id="remove" value=',str,' class="button" onClick="javascript:custom2Action();">\
	')
}
...
document.writeln('\
<input type="button" name="back" id="back" value="&lt; ',top.BACK,'" class="button" onclick="javascript:cancelAction()">\
')
...
document.writeln('\
 <input type="button" name="new" id="new" value="',top.bNEW,'" class="button" onclick="javascript:createNewAction(\'',link,'\');">\
');
}
...
debugMsg("getHtmlForCreateNewButton access granted");
document.writeln('\
 <input type="button" name="new" id="new" value=',str,' class="buttonstretch" onclick="javascript:createNewAction(\'',link,'\');">\
');
}
...
function getHtmlForNewApplyButton(){
	document.writeln('\
	<input type="button" name="apply" id="apply" value="',top.APPLY,'" class="button" onClick="javascript:createSubmitAction()">\
	')
}
